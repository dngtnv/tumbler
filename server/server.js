...
app.get('/user/:username/photos/:number/offset=:offset', async (req, res, next) => {
  try {
    const data = await getImageUrls(req.params.username, +req.params.number, +req.params.offset);
